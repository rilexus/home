...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e52181dc42782cebb619";
...
"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst app_controller_1 = __webpack_require__(/*! ./app.controller */ \"./src/app.controller.ts\");\nconst app_service_1 = __webpack_require__(/*! ./app.service */ \"./src/app.service.ts\");\nconst cv_module_1 = __webpack_require__(/*! ./controllers/cv/cv.module */ \"./src/controllers/cv/cv.module.ts\");\nlet AppModule = class AppModule {\n};\nAppModule = __decorate([\n    common_1.Module({\n        imports: [\n            cv_module_1.CvModule\n        ],\n        controllers: [app_controller_1.AppController],\n        providers: [\n            app_service_1.AppService,\n        ],\n    })\n], AppModule);\nexports.AppModule = AppModule;\n\n\n//# sourceURL=webpack:///./src/app.module.ts?");
...
/***/ "./src/controllers/cv/cv.controller.ts":
/*!*********************************************!*\
  !*** ./src/controllers/cv/cv.controller.ts ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__dirname) {\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nvar __metadata = (this && this.__metadata) || function (k, v) {\n    if (typeof Reflect === \"object\" && typeof Reflect.metadata === \"function\") return Reflect.metadata(k, v);\n};\nvar __param = (this && this.__param) || function (paramIndex, decorator) {\n    return function (target, key) { decorator(target, key, paramIndex); }\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst cv_service_1 = __webpack_require__(/*! ./cv.service */ \"./src/controllers/cv/cv.service.ts\");\nconst path_1 = __webpack_require__(/*! path */ \"path\");\nlet CvController = class CvController {\n    constructor(cvService) {\n        this.cvService = cvService;\n    }\n    root(res) {\n        res.sendFile(__dirname + '/index.html');\n    }\n    download(query, res) {\n        return __awaiter(this, void 0, void 0, function* () {\n            common_1.Logger.log('reached', 'CvController');\n            const valid = yield this.cvService.checkPassword(query);\n            console.log(valid);\n            if (valid) {\n                res.setHeader(\"Content-Disposition\", [\"attachment\", \"filename=Lebenslauf.pdf\"]);\n                res.setHeader(\"Content-Type\", 'application/octet-stream');\n                res.download(path_1.resolve('client/build/documents/Lebenslauf.pdf'));\n            }\n            else {\n                res.status(403);\n                res.send();\n            }\n        });\n    }\n};\n__decorate([\n    common_1.Get(),\n    __param(0, common_1.Res()),\n    __metadata(\"design:type\", Function),\n    __metadata(\"design:paramtypes\", [Object]),\n    __metadata(\"design:returntype\", void 0)\n], CvController.prototype, \"root\", null);\n__decorate([\n    common_1.Post('/download'),\n    __param(0, common_1.Body('query')), __param(1, common_1.Res()),\n    __metadata(\"design:type\", Function),\n    __metadata(\"design:paramtypes\", [Object, Object]),\n    __metadata(\"design:returntype\", Promise)\n], CvController.prototype, \"download\", null);\nCvController = __decorate([\n    common_1.Controller('cv'),\n    __metadata(\"design:paramtypes\", [cv_service_1.CvService])\n], CvController);\nexports.CvController = CvController;\n\n/* WEBPACK VAR INJECTION */}.call(this, \"/\"))\n\n//# sourceURL=webpack:///./src/controllers/cv/cv.controller.ts?");

/***/ }),

/***/ "./src/controllers/cv/cv.module.ts":
/*!*****************************************!*\
  !*** ./src/controllers/cv/cv.module.ts ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst cv_controller_1 = __webpack_require__(/*! ./cv.controller */ \"./src/controllers/cv/cv.controller.ts\");\nconst cv_service_1 = __webpack_require__(/*! ./cv.service */ \"./src/controllers/cv/cv.service.ts\");\nlet CvModule = class CvModule {\n};\nCvModule = __decorate([\n    common_1.Module({\n        imports: [],\n        controllers: [cv_controller_1.CvController],\n        providers: [\n            cv_service_1.CvService,\n        ],\n    })\n], CvModule);\nexports.CvModule = CvModule;\n\n\n//# sourceURL=webpack:///./src/controllers/cv/cv.module.ts?");

/***/ }),

/***/ "./src/controllers/cv/cv.service.ts":
/*!******************************************!*\
  !*** ./src/controllers/cv/cv.service.ts ***!
  \******************************************/
/*! no static exports found */
